package com.site.common.framework.key;
...
public class FactoryAboutKey {
    ...
    public void init() throws Exception {
        ...
        log.debug("# master key properties ={}", JSON.toJSONString(masterKeyPropertiesMap));
        log.debug("# master db properties ={}", JSON.toJSONString(masterTabMap));
        ...
        // 拼装master主键id
        List<Key> masterTabPkValues = keyService.getMasterDBTableValues(masterKeys);
        ...
        List<Key> slaveTabs = keyService.getSlaveDBTables();
        ...
        log.debug("# slave key properties ={}", JSON.toJSONString(slaveKeyPropertiesMap));
